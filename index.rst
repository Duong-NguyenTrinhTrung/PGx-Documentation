...
.. _ATC classification hierachy browser: https://pgx-documentation.readthedocs.io/en/latest/atc_code.html
.. _Drug search: https://pgx-documentation.readthedocs.io/en/latest/drugs.html
.. _Indication search: https://pgx-documentation.readthedocs.io/en/latest/diseases.html
...
.. csv-table:: **PAGES**
   ...
   "`ATC classification hierachy browser`_",  "The page allows browsing through the ATC code system, seeing drug profiles |br| as well as information indexed at an ATC code in 5 
   ...
   "`Indication search`_", "This page offers a search tool and presents essential details about indications, |br| connections to drug-indications association networks, and 
   statistical data related to indications."
   "`Target search`_",  "This page provides access to a search feature, view key details on |br| drug-interacting proteins, and examine statistics concerning these proteins"
